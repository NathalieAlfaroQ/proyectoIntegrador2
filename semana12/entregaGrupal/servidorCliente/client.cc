 //   std::string figura = (argc > 2) ? argv[2] : "../Figuras/jessica.txt";
...
int main(int argc, char *argv[])
{
    ...
    {
        request = "ADD \nBEGIN/" + filename + "/\ncontentLength" + std::to_string(filecontent.size()) + "/\nEND\n" + filecontent;
    }
