...
Si quiere limpiar el archivo binario y generar uno nuevo, debe eliminar el archivo binario
y generar otro de forma manual con g++ -o generador generador.cc para compilar
y ejecutar con ./generador
*/
