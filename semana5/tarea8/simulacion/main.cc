...
int main()
{
     ...
     */
    string figuraAnimal;
    cout << "200 OK Figuras disponibles, digite una en minúscula: \n - pinguino \n - perro \n"
         << endl;
    cin >> figuraAnimal;

    if (figuraAnimal != "perro" && figuraAnimal != "pinguino")
    {
        cout << "404 - Not found - La figura no existe en el sistema de archivos" << endl;
        return 0;
    }
