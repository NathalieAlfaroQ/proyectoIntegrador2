...
Servidor::Servidor(const string &figura)
{
    ...
    if (archivo.is_open())
    {
        ...
        cout << "Servidor encendido, IP 192.168.1.10, Puerto 8080." << endl;
    }
}
...
void Servidor::detener()
{
    ...
    corriendo = false;
    cout << "Tenedor apagado, IP 192.168.1.10, Puerto 1234." << endl;
    cout << "Servidor apagado, IP 192.168.1.10, Puerto 8080." << endl;
...
void Servidor::enviarSolicitud(const Mensaje &msg)
{
    if (corriendo == false)
    {
        cout << "No se puede establecer conexión con el servidor." << endl;
        return;
    }
